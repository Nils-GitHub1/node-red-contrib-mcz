    ...
    _parseField(field, parts) {
        switch (field.type) {
            ...
            case 'map': {
                ...
                // include codes in output to make it easier for Node-RED logic: sometimes automation needs: state_code:13 not only state:"Power 3"
                return {code:v, m[v] !== undefined ? m[v] : `Unknown (${v})`};
            }
